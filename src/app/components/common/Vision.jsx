        ...
        <div className="py-[40px] md:py-[80px] lg:py-[120px] bg-[#19172F]">
          <div className="max-w-[1352px] px-4 sm:px-6 md:px-9 lg:px-12 xl:px-[80px] mx-auto">
            <div className="text-center">
              ...
              <Para
                className={
                  "max-w-[841px] text-center mx-auto mt-5 !text-sm md:!text-base lg:!text-lg"
                }
                subtitle={
            ...
            <div className="mt-15 flex  ml-0 xl:ml-[80px]   overflow-scroll hide-scrollbar  max-w-[500px]">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id)}
                  className={`rounded-[5px] !text-sm md:!text-base text-nowrap py-[7px] md:py-[11px] px-[17px] md:px-[27px] ${
                    activetab === tab.id
