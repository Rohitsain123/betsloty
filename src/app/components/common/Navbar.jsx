    ...
    <>
      <div className="bg-[#19172F]">
        <div className="max-w-[1410px] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[50px] pt-3 md:pt-4 lg:pt-5 pb-4 md:pb-6 lg:pb-[25px] mx-auto">
            ...
            <div className="hidden lg:block">
              <div className="flex items-center gap-5 xl:gap-[40px]">
                ...
                <div className="flex gap-[15px]">
                  ...
                  <Loginbtn
                    className="bg-[#C2BF28] !text-[#2D2A4B] font-bold hover:!bg-[#2D2A4B] hover:!text-[#fff]"
                    title={"SIGN UP"}
                  />
                </div>
              </div>
          ...
          {/* Sidebar for mobile */}
          {show && (
            <div className="w-[100%] sm:w-[60%] fixed right-0 top-0 bg-[#19172F] h-[100%] pt-3 sm:pt-4 pb-4 px-4 sm:px-6 block lg:hidden z-[999]">
