    ...
    <>
      <div className="bg-[#19172F] pt-[40px] md:pt-[70px] lg:pt-[100px] pb-[-100px] sm:pb-[-80px] md:pb-[-50px] lg:pb-[40px]">
        <div className="max-w-[1352px] px-4 sm:px-6 md:px-9 lg:px-12 xl:px-[80px] mx-auto">
          ...
          />
          <div>
            <div className="flex flex-wrap lg:flex-nowrap  gap-[50px] lg:gap-[30px] items-center justify-center lg:justify-between">
              <div className="mb-[-100px] sm:mb-[-150px] lg:mb-0">
                <Heading
                  className={
